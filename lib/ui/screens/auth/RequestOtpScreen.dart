...
class RequestOtpState extends State<RequestOtp> {
  ...
  setMono() {
    ...
    return Expanded(
      child: Padding(
        ...
        child: Container(
            height: 55,
            width: MediaQuery.of(context).size.width * 0.57, //width - 245,
    ...
    try {
      await _auth.verifyPhoneNumber(
        ...
        verificationFailed: (FirebaseAuthException exception) {
          ...
          // debugPrint("${exception.code} -- ${exception.message}");
      ...
      // debugPrint("Firebase AuthException - ${authError.code} & ${authError.message}");
  ...
  reqOtpBtn() {
    return Container(
      alignment: Alignment.center,
      padding: const EdgeInsets.only(top: 60.0), //top: 120.0
      child: InkWell(
        child: Container(
          height: 55.0,
          //48.0,
          ...
          child: CustomTextLabel(
            text: 'reqOtpLbl',
            textStyle: Theme.of(context).textTheme.titleLarge?.copyWith(color: secondaryColor, fontWeight: FontWeight.w600, letterSpacing: 0.5, fontSize: 21),
          ),
        ),
        onTap: () async {
