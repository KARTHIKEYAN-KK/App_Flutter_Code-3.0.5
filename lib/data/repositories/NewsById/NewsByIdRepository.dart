...
class NewsByIdRepository {
  ...
  Future<Map<String, dynamic>> getNewsById({required BuildContext context, required String newsId, required String langId, required String userId}) async {
    final result = await _newsByIdRemoteDataSource.getNewsById(context: context, newsId: newsId, langId: langId, userId: userId);
