    ...
    return PreferredSize(
        ...
        child: AppBar(
          ...
          title: Transform(
            ...
            child: Text(
              UiUtils.getTranslatedLabel(context, 'newsLbl'),
                        ...
                        child: Row(
                          ...
                          children: [
                            InkWell(
                              ...
                              onTap: () {
                                Navigator.of(context).pushNamed(Routes.editNews, arguments: {
                                  "model": model,
                                });
                              },
                            ),
        ...
        body: BlocBuilder<GetUserNewsCubit, GetUserNewsState>(
          builder: (context, state) {
            ...
            if (state is GetUserNewsFetchFailure) {
              return Center(
                  child: Text(
                UiUtils.getTranslatedLabel(context, 'noNews'),
