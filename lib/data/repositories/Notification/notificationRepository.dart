...
class NotificationRepository {
  ...
  Future<Map<String, dynamic>> getNotification({required BuildContext context, required String offset, required String limit, required String langId}) async {
    final result = await _notificationRemoteDataSource.getNotifications(limit: limit, offset: offset, context: context, langId: langId);
