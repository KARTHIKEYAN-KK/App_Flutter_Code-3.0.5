...
class Style1SectionState extends State<Style1Section> {
  int? style1Sel;
  PageController? _pageStyle1Controller;
      ...
      return Column(
        ...
        children: [
          ...
          if (model.newsType == 'news' || model.videosType == "news")
            if (model.newsType == 'news' ? model.news!.isNotEmpty : model.videos!.isNotEmpty) style1NewsData(model),
  ...
  Widget style1NewsData(FeatureSectionModel model) {
    ...
    return Column(
      ...
      children: [
        SizedBox(
          ...
          child: PageView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              NewsModel data = model.newsType == 'news' ? model.news![index] : model.videos![index];
        ...
        style1Indicator(model, model.newsType == 'news' ? model.news!.length : model.videos!.length)
      ],
    );
  }
