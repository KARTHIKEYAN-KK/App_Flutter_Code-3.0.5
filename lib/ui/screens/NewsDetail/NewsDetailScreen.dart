...
import 'Widgets/InterstitialAds/fbInterstitialAds.dart';
import 'Widgets/NewsSubDetailsScreen.dart';
    ...
    return PageView.builder(
        ...
        onPageChanged: (index) async {
          if (await InternetConnectivity.isNetworkAvailable()) {
            ...
            if (index % interstitialAdsIndex == 0) {
              if (context.read<AppConfigurationCubit>().checkAdsType() == "google") {
                showGoogleInterstitialAd(context);
              } else if (context.read<AppConfigurationCubit>().checkAdsType() == "fb") {
                showFBInterstitialAd();
              } else {
                showUnityRewardAds(context.read<AppConfigurationCubit>().interstitialId()!);
              }
            }
          }
        },
