    ...
    if (widget.from == 1) {
      if (widget.model!.contentValue != "" || widget.model!.contentValue != null) {
        if (widget.model!.contentType == "video_upload") {
          flickManager = FlickManager(videoPlayerController: VideoPlayerController.network(widget.model!.contentValue!), autoPlay: true); //false
      ...
      if (widget.breakModel!.contentValue != "" || widget.breakModel!.contentValue != null) {
        if (widget.breakModel!.contentType == "video_upload") {
          flickManager = FlickManager(videoPlayerController: VideoPlayerController.network(widget.breakModel!.contentValue!), autoPlay: true); //false
            ...
            child: Padding(
              ...
              child: ClipRRect(
                  ...
                  child: Container(
                      ...
                      decoration: BoxDecoration(color: UiUtils.getColorScheme(context).background, shape: BoxShape.circle),
                      child: Icon(
