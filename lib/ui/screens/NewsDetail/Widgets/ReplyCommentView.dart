                            ...
                            if (state is LikeAndDislikeCommSuccess) {
                              if (state.fromLike) {
                                if (state.comment.like == "1") {
                                  ...
                                  setState(() {});
                                } else if (state.comment.dislike == "1") {
                                  model.dislike = "0";

                                  if (model.totalDislikes!.isNotEmpty) {
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () {
                                      if (context.read<AuthCubit>().getUserId() != "0") {
                                        if (model.like == "1") {
                                          context.read<LikeAndDislikeCommCubit>().setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "0", fromLike: true);
                                        } else if (model.dislike == "1") {
                                          context.read<LikeAndDislikeCommCubit>().setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "1", fromLike: true);
                                        }
                                      } else {
                                          ...
                                          if (context.read<AuthCubit>().getUserId() != "0") {
                                            if (model.dislike == "1") {
                                              context
                                                  ...
                                                  .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "0", fromLike: false);
                                            } else if (model.like == "1") {
                                              context
                                                  .read<LikeAndDislikeCommCubit>()
                                                  .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "2", fromLike: false);
                                            }
                                          } else {
                                            loginRequired(context);
                                          }
              ...
              children: [
                Expanded(
                    ...
                    child: context.read<AuthCubit>().getProfile() != ""
                        ? CircleAvatar(
                            backgroundImage: NetworkImage(context.read<AuthCubit>().getProfile()),
                          )
                        : const SizedBox(
                            height: 35,
                            width: 35,
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    icon: Icon(
                                      Icons.send,
                                      color: replyComEnabled ? UiUtils.getColorScheme(context).primaryContainer.withOpacity(0.8) : Colors.transparent,
                                      size: 20.0,
                                    ),
                                    onPressed: () async {
                                      if (context.read<AuthCubit>().getUserId() != "0") {
                                        context.read<SetCommentCubit>().setComment(userId: context.read<AuthCubit>().getUserId(), parentId: model.id!, newsId: widget.newsId, message: _replyComC.text);
                                      } else {
                                        loginRequired(context);
                                      }
                                    },
                        ...
                        return Row(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                          model.replyComList![index].profile != null || model.replyComList![index].profile != ""
                              ? Container(
                                  ...
                                  child: CircleAvatar(
                                    backgroundImage: NetworkImage(model.replyComList![index].profile!),
                                    radius: 32,
                                  ))
                              : const SizedBox(
                                  height: 35,
                                            ...
                                            if (state is LikeAndDislikeCommSuccess) {
                                              if (state.fromLike) {
                                                if (state.comment.replyComList![index].like == "1") {
                                                  ...
                                                  setState(() {});
                                                } else if (state.comment.replyComList![index].dislike == "1") {
                                                ...
                                                if (state.comment.replyComList![index].dislike == "1") {
                                                  ...
                                                  setState(() {});
                                                } else if (state.comment.replyComList![index].like == "1") {
                                                  model.replyComList![index].like = "0";
                                              ...
                                              child: Row(
                                                children: [
                                                  InkWell(
                                                    ...
                                                    onTap: () {
                                                      if (context.read<AuthCubit>().getUserId() != "0") {
                                                        if (model.replyComList![index].like == "1") {
                                                          context
                                                              .read<LikeAndDislikeCommCubit>()
                                                              .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "0", fromLike: true);
                                                        } else if (model.replyComList![index].dislike == "1") {
                                                          context
                                                              .read<LikeAndDislikeCommCubit>()
                                                              .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "1", fromLike: true);
                                                        } else {
                                                          context
                                                              .read<LikeAndDislikeCommCubit>()
                                                              .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "1", fromLike: true);
                                                  ...
                                                  model.replyComList![index].totalLikes! != "0"
                                                      ? Padding(
                                                          padding: const EdgeInsetsDirectional.only(start: 4.0),
                                                          child: Text(
                                                            model.replyComList![index].totalLikes!,
                                                            style: Theme.of(context).textTheme.titleSmall?.copyWith(
                                                                  color: UiUtils.getColorScheme(context).primaryContainer,
                                                                ),
                                                          ),
                                                  ...
                                                  Padding(
                                                      ...
                                                      child: InkWell(
                                                        ...
                                                        onTap: () {
                                                          if (context.read<AuthCubit>().getUserId() != "0") {
                                                            if (model.replyComList![index].dislike == "1") {
                                                              context
                                                                  .read<LikeAndDislikeCommCubit>()
                                                                  .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "0", fromLike: false);
                                                            } else if (model.replyComList![index].like == "1") {
                                                              context
                                                                  .read<LikeAndDislikeCommCubit>()
                                                                  .setLikeAndDislikeComm(userId: context.read<AuthCubit>().getUserId(), comment: model, status: "2", fromLike: false);
                                                            } else {
                                                  ...
                                                  model.replyComList![index].totalDislikes! != "0"
                                                      ? Padding(
                                                          padding: const EdgeInsetsDirectional.only(start: 4.0),
                                                          child: Text(
                                                            model.replyComList![index].totalDislikes!,
                                                            style: Theme.of(context).textTheme.titleSmall?.copyWith(
                                                                  color: UiUtils.getColorScheme(context).primaryContainer,
                                                                ),
                                                          ),
  ...
  Widget replyCommentView() {
    return BlocBuilder<CommentNewsCubit, CommentNewsState>(builder: (context, state) {
      ...
      if (state is CommentNewsFetchFailure) {
        return Center(
            child: Text(
          UiUtils.getTranslatedLabel(context, 'comNotAvail'),
          textAlign: TextAlign.center,
        ));
      }
      //state is CommentNewsFetchInProgress || state is CommentNewsInitial
      return Padding(padding: const EdgeInsets.only(bottom: 10.0, left: 10.0, right: 10.0), child: Container());
    });
  }
