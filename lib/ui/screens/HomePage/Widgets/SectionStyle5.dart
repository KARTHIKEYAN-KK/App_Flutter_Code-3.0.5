...
class Style5Section extends StatelessWidget {
  ...
  Widget style5SingleNewsData(FeatureSectionModel model, BuildContext context) {
    NewsModel data = model.newsType == 'news' ? model.news![0] : model.videos![0];
    return InkWell(
      child: Container(
    ...
    if (model.breakVideos!.isNotEmpty || model.breakNews!.isNotEmpty || model.videos!.isNotEmpty || model.news!.isNotEmpty) {
      return Column(
        ...
        children: [
          ...
          if (model.newsType == 'news' || model.videosType == "news")
            if (model.newsType == 'news' ? model.news!.isNotEmpty : model.videos!.isNotEmpty)
              Column(
                mainAxisSize: MainAxisSize.min,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  style5SingleNewsData(model, context),
                  if (model.newsType == 'news' ? model.news!.length > 1 : model.videos!.length > 1)
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemCount: model.newsType == 'news' ? model.news!.length : model.videos!.length,
                          itemBuilder: (BuildContext context, int index) {
                            if (model.newsType == 'news' ? model.news!.length > index + 1 : model.videos!.length > index + 1) {
                              NewsModel data = model.newsType == 'news' ? model.news![index + 1] : model.videos![index + 1];
                              return InkWell(
                                child: SizedBox(
