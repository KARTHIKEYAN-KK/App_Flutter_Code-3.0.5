...
class SectionByIdRepository {
  ...
  Future<List<FeatureSectionModel>> getSectionById({required String offset, required String limit, required String userId, required String langId, required String sectionId}) async {
    final result = await _sectionByIdRemoteDataSource.getSectionById(limit: limit, offset: offset, langId: langId, userId: userId, sectionId: sectionId);
