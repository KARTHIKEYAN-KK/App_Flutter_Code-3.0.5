    ...
    FirebaseDynamicLinks.instance.onLink.listen((dynamicLink) {
      ...
      if (deepLink.queryParameters.isNotEmpty) {
        ...
        if (isBreakingNews == "true") {
          ...
          context.read<NewsByIdCubit>().getNewsById(context: context, newsId: id, langId: context.read<AppLocalizationCubit>().state.id, userId: context.read<AuthCubit>().getUserId()).then((value) {
            if (value.isNotEmpty) {
              if (isVideoID == 'true') {
