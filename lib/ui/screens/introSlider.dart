...
class GettingStartedScreenState extends State<IntroSliderScreen> with TickerProviderStateMixin {
  ...
  appbar() {
    return PreferredSize(
      ...
      child: Padding(
        padding: EdgeInsetsDirectional.only(top: MediaQuery.of(context).padding.top + 10.0, start: 20, end: 16),
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          CustomTextButton(
              onTap: () {
                ...
                Navigator.of(context).pushReplacementNamed(Routes.languageList, arguments: {"from": 1});
              },
  ...
  Widget titleText(int index) {
    return Container(
      ...
      child: Text(
        ...
        style: Theme.of(context).textTheme.headlineMedium?.copyWith(color: backgroundColor, fontWeight: FontWeight.bold, letterSpacing: 0.5),
      ),
    );
  }
