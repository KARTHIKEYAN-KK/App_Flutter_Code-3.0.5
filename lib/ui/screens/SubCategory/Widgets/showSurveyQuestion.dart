...
class ShowSurveyQue extends StatefulWidget {
  ...
  const ShowSurveyQue({super.key, required this.model, required this.index, required this.updateList});
    ...
    return BlocConsumer<SetSurveyAnsCubit, SetSurveyAnsState>(
        ...
        listener: (context, state) {
          ...
          if (state is SetSurveyAnsFetchSuccess) {
            context.read<SurveyQuestionCubit>().removeQuestion(widget.index);
          ...
          return BlocConsumer<GetSurveyAnsCubit, GetSurveyAnsState>(
              ...
              listener: (context, state) {
                ...
                if (state is GetSurveyAnsFetchSuccess) {
                  // debugPrint("state ans****${state.getSurveyAns}******${widget.model.id}");
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: InkWell(
                                  ...
                                  onTap: () async {
                                    if (optSel != null) {
                                      context.read<SetSurveyAnsCubit>().setSurveyAns(context: context, userId: context.read<AuthCubit>().getUserId(), optId: optSel!, queId: widget.model.id!);
                                    } else {
