...
const String jwtKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9";

//Please add here your default country code
const String yourCountryCode = 'IN';

//jwt key issuer name
const String issuerName = 'NewsAPP';

//jwt key issuer subject name
const String issSubjectName = 'News APP Authentication';
...
const String packageName = 'com.news.wrteam';
const String androidLink = 'https://play.google.com/store/apps/details?id=';

const String iosPackage = 'com.news.wrteam';
...
const String deepLinkUrlPrefix = 'https://knewsnew.page.link/app';
const String deepLinkName = 'K News';
